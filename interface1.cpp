...
void interface1::on_pb_ajouter_clicked()
{
  ...
  client c(id,nom,prenom,sexe,date_de_naissance,adressemail);
    ...
    QMessageBox::information(nullptr, QObject::tr("Ajouter un client"),
     ...
     painter.drawText(20,600,"sexe :");
     painter.drawText(20,700,"adresse mail :");
     font.setPixelSize(22);
     painter.setFont(font);
     painter.setPen(Qt::black);
     painter.drawText(250,300,nom);
     painter.drawText(250,400,prenom);
     painter.drawText(350,500,date_de_naissance);
     painter.drawText(250,600,sexe);
     painter.drawText(250,700,adressemail);
     painter.end();
     //
     //
}
...
{
    if(arg1 == ""){
        ui->tableView->setModel(c.afficher());//naabi m tab l je m base de donée te3i
    }else{
